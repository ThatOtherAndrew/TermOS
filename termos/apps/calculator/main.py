...
class Calculator(OSApp):
    NAME = 'Calculator'
    ICON = '🔢'
    DESCRIPTION = 'macOS-inspired simple calculator'

    @staticmethod
    def launch(os: TermOS) -> None:
        instance = Calculator(os)
        instance.create_window(CalculatorWidget(), 'calculator', width=38, height=28)
